CREATE DATABASE  IF NOT EXISTS `xcom_app` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `xcom_app`;
-- MySQL dump 10.13  Distrib 5.5.28, for debian-linux-gnu (i686)
--
-- Host: localhost    Database: xcom_app
-- ------------------------------------------------------
...
INSERT INTO `ranks` VALUES (1,'Rookie'),(2,'Squaddie'),(3,'Corporal'),(4,'Sergeant'),(5,'Lieutenant'),(6,'Captain'),(7,'Major'),(8,'Colonel');
...
CREATE TABLE `soldiers` (
  ...
  `aim` int(11) DEFAULT '0',
  `hp` int(11) DEFAULT '0',
  `dead` int(1) DEFAULT '0',
  `psionic` int(11) DEFAULT '0',
  `country_id` int(11) NOT NULL,
  `class_id` int(11) DEFAULT NULL,
  `rank_id` int(11) DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `fk_soldiers_1` (`country_id`),
  KEY `fk_soldiers_2` (`class_id`),
  KEY `fk_soldiers_3` (`rank_id`),
  CONSTRAINT `fk_soldiers_1` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_soldiers_2` FOREIGN KEY (`class_id`) REFERENCES `classes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_soldiers_3` FOREIGN KEY (`rank_id`) REFERENCES `ranks` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `classes` VALUES (1,'Assault'),(2,'Support'),(3,'Heavy'),(4,'Sniper');
/*!40000 ALTER TABLE `classes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `soldier_history`
--

DROP TABLE IF EXISTS `soldier_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `soldier_history` (
  ...
  `hp` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_soldier_history_1` (`soldier_id`),
  CONSTRAINT `fk_soldier_history_1` FOREIGN KEY (`soldier_id`) REFERENCES `soldiers` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=188 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `soldier_history`
--
...
-- Dump completed on 2013-04-02 17:14:42
